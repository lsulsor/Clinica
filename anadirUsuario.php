...
$contraUsu = trim($_POST["contraUsu"]);
$contraUsuR = trim($_POST["contraUsuR"]);
$fechaAltaUsu = trim($_POST["fechaAltaUsu"]);
$fechaBajaUsu = trim($_POST["fechaBajaUsu"]);
$estadoUsu = trim($_POST["estadoUsu"]);


echo DB::anadirUsuario($dniUsu, $nombreUsu, $apellidoUsu, $fechaNacUsu, $responsableUsu, $calleUsu, $numeroUsu, $pisoUsu, $letraUsu, $cpUsu, $provinciaUsu, $telefonoUsu, $correoUsu , $usuarioUsu, $contraUsu, $contraUsuR, $fechaAltaUsu, $fechaBajaUsu, $estadoUsu);
