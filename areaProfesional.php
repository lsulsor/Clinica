  ...
  <?php
    ...
    <div class="d-flex justify-content-center align-items-center container pt-lg-5 pb-5">
        <div class="col-lg-4 col-lg-offset-4">
            <!--Formuario de loguin-->
            <form class="col-md-20" action="comprueba_Profesional.php" method="POST">
                <TABLE class="table table-light table-hover">
                    <tr>
                        ...
                        <td><input class="border border-secondary rounded form-control form-control-sm" type="text" name="loginProf" id="loginProf" required autofocus></td>
                    </tr>
                    <tr>
                        ...
                        <td><input class="border border-secondary rounded form-control form-control-sm" type="password" name="passwordProf" id="passwordProf" required></td>
                    </tr>
